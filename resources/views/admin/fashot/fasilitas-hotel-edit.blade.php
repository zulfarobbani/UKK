...
<form action="/admin/fasilitas-hotel/update/{{ $item->id }}" method="post" enctype="multipart/form-data">
    @csrf
<div class="row justify-content-center">
    <div class="mb-3 col-sm-8">
        <label for="exampleInputEmail1" class="form-label">Nama Fasilitas Hotel : </label>
        <input type="text" class="form-control" id="exampleInputEmail1" name="nama_fashot" value="{{ $item->nama_fashot}}" required>
    </div>
    <div class="mb-3 col-sm-8">
        <label for="exampleInputPassword1" class="form-label">Deskripsi : </label>
        <textarea name="deskripsi" id="" class="form-control">{{ $item->deskripsi }}</textarea>
